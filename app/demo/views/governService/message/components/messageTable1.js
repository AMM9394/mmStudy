        ...
        <div className="creator">
          {
            record.c!==null?
              ...
              >
                <a><span className="re-load same"><img src={pic2} />重新上传</span></a>
              </Upload>:
              <Upload action="//jsonplaceholder.typicode.com/posts/"
                listType="text"
              ...
              >
                <a><span className="load same"><img src={pic6} />上传</span></a>
              </Upload>
          }
          <Popconfirm title="确认删除?" onConfirm={this.onDelete.bind(this,record.key)}>
            <a ><span className="delete same"><img src={pic5} />删除</span></a>
          </Popconfirm>
        </div>
      ),
    }];
